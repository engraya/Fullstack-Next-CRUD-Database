...
<header className="py-4 px-4 sm:px-10 z-50 min-h-[70px]">
  <div className="relative flex flex-wrap items-center gap-4">
    ...
    <div className="flex ml-auto lg:order-1">
      <button className="px-6 py-3 mx-3 rounded-xl text-white bg-cyan-900 transition-all hover:bg-cyan-800">Login</button>
      <button className="px-6 py-3 mx-3 rounded-xl text-white bg-red-600 transition-all hover:bg-cyan-800">Logout</button>
    </div>
