  ...
  <div className="bg-[#f8f9ff] font-[sans-serif] text-[#333] text-[15px]">
    <header className="py-4 px-4 sm:px-10 z-50 min-h-[70px]">
      <div className="relative flex flex-wrap items-center gap-4">
        ...
        <ul id="collapseMenu" className="lg:!flex lg:ml-12 lg:space-x-6 max-lg:space-y-6 max-lg:hidden max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[250px] max-lg:top-0 max-lg:left-0 max-lg:p-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto max-lg:z-50">
      ...
      <div className="mt-32 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8">
          ...
          <div className="sm:p-6 p-4 flex bg-white rounded-md border">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 mr-6 bg-blue-50 p-3 rounded-md shrink-0" viewBox="0 0 682.667 682.667">
              <defs>
          ...
          <div className="sm:p-6 p-4 flex bg-white rounded-md border">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 mr-6 bg-blue-50 p-3 rounded-md shrink-0" viewBox="0 0 512.001 512.001">
          ...
          <div className="sm:p-6 p-4 flex bg-white rounded-md border">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 mr-6 bg-blue-50 p-3 rounded-md shrink-0" viewBox="0 0 24 24">
          ...
          <div className="sm:p-6 p-4 flex bg-white rounded-md border shadow-[0_14px_40px_-11px_rgba(93,96,127,0.2)]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 mr-6 bg-blue-50 p-3 rounded-md shrink-0" viewBox="0 0 504.69 504.69">
      ...
      <div className="mt-32 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8 mt-16 max-md:max-w-lg max-md:mx-auto">
          <div className="bg-white rounded sm:p-6 p-4">
            ...
            <div className="mt-6">
              <h2 className="text-4xl font-bold">$0<span className="text-gray-500 ml-2 text-[15px]">/ Month</span></h2>
              <button type="button" className="w-full mt-6 px-6 py-3 rounded-xl text-white bg-cyan-900 transition-all hover:bg-cyan-800">Get
                Started</button>
            </div>
            <div className="mt-6">
          ...
          <div className="bg-blue-600 rounded sm:p-6 p-4 text-white shadow-lg shadow-blue-300">
            ...
            <div className="mt-6">
              <h2 className="text-4xl font-bold">$25<span className="text-gray-200 ml-2 text-[15px]">/ Month</span></h2>
              <button type="button" className="w-full mt-6 px-6 py-3 rounded-xl text-[#333] bg-white transition-all hover:bg-gray-100">Get
                Started</button>
            </div>
            <div className="mt-6">
              <h4 className="text-base font-bold mb-4">Plan Includes</h4>
          ...
          <div className="bg-white rounded sm:p-6 p-4">
            <h3 className="text-xl font-extrabold">Enterprise</h3>
            <p className="mt-2">Ideal for businesses who need personalized services and security for large teams.</p>
            <div className="mt-6">
              <h2 className="text-4xl font-bold">$100<span className="text-gray-500 ml-2 text-[15px]">/ Month</span></h2>
              <button type="button" className="w-full mt-6 px-6 py-3 rounded-xl text-white bg-cyan-900 transition-all hover:bg-cyan-800">Get
                Started</button>
            </div>
            <div className="mt-6">
        ...
        <div className="sm:max-w-7xl max-w-sm mx-auto">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-8 gap-y-20 text-center mt-32">
            <div className="bg-gray-200 relative rounded">
              <img src="https://readymadeui.com/team-1.webp" className="w-32 h-32 rounded-full inline-block -mt-12" />
              <div className="py-6">
                <h4 className="text-base font-extrabold">John Doe</h4>
                <p className="text-xs mt-1">Software Engineer</p>
                <div className="space-x-4 mt-6">
                  <button type="button" className="w-7 h-7 inline-flex items-center justify-center rounded-full border-none outline-none bg-gray-100 hover:bg-gray-200">
            ...
            <div className="bg-gray-200 relative rounded">
              <img src="https://readymadeui.com/team-3.webp" className="w-32 h-32 rounded-full inline-block -mt-12" />
              <div className="py-6">
            ...
            <div className="bg-gray-200 relative rounded">
              <img src="https://readymadeui.com/team-6.webp" className="w-32 h-32 rounded-full inline-block -mt-12" />
              <div className="py-6">
      ...
      <div className="bg-white mt-32 px-4 py-12">
        <div className="grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto max-w-5xl">
          <div>
            ...
            <p className="mt-6">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about
          ...
          <form className="ml-auo space-y-4">
            <input type="text" placeholder="Name" className="w-full rounded-md py-3 px-4 bg-[#f8f9ff] outline-cyan-900" />
            <input type="email" placeholder="Email" className="w-full rounded-md py-3 px-4 bg-[#f8f9ff] outline-cyan-900" />
            <input type="text" placeholder="Subject" className="w-full rounded-md py-3 px-4 bg-[#f8f9ff] outline-cyan-900" />
            <textarea placeholder="Message" rows={6} className="w-full rounded-md px-4 bg-[#f8f9ff] pt-3 outline-cyan-900" defaultValue={""} />
            <button type="button" className="w-full mt-6 px-6 py-3 rounded-xl text-white bg-cyan-900 transition-all hover:bg-cyan-800">Send</button>
          </form>
        </div>
      </div>
      <div className="bg-blue-100 py-20 sm:px-6 px-4 rounded-3xl mt-32">
        <div className="max-w-4xl w-full mx-auto text-center">
          ...
          <div className="mt-10 bg-white flex items-center p-2 max-w-xl mx-auto rounded-2xl border border-gray-300">
            <input type="email" placeholder="Enter your email" className="w-full bg-transparent py-4 px-2 border-none outline-none" />
    ...
    <footer className="bg-cyan-900 px-4 sm:px-10 py-12 mt-32">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
          <h4 className="text-white font-extrabold text-xl mb-6">Quick Links</h4>
          <ul className="space-y-4">
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Our Story</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Newsroom</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Careers</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Blog</a>
            </li>
          </ul>
        </div>
        <div>
          <h4 className="text-white font-extrabold text-xl mb-6">Services</h4>
          <ul className="space-y-4">
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Web Development</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Testing Automation</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">AWS Development
                Services</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Mobile App
                Development</a>
            </li>
          </ul>
        </div>
        <div>
          <h4 className="text-white font-extrabold text-xl mb-6">Platforms</h4>
          <ul className="space-y-4">
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Hubspot</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Marketo Integration
                Services</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Marketing Glossary</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">UIPath</a>
            </li>
          </ul>
        </div>
        <div>
          <h4 className="text-white font-extrabold text-xl mb-6">Company</h4>
          <ul className="space-y-4">
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Accessibility</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">About</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Contact</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-300 transition-all">Learn more</a>
            </li>
          </ul>
        </div>
      </div>
